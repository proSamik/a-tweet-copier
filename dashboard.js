/**
 * Dashboard script for Tweet Copier extension
 * Provides functionality for the full-page dashboard view
 */

/**
 * Tweet storage management functions
 */
const tweetStorage = {
  /**
  ...
  exportAsJson: () => {
    tweetStorage.getSavedTweets((tweets) => {
      ...
      const exportFileDefaultName = `tweet_copier_export_${new Date().toISOString().slice(0,10)}.json`;
...
/**
 * Updates the table of tweets in the dashboard
